   ...
   <div class="store-nav">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          @if (isset($count))
            <strong style="margin-left:15px">found  {{$count}} <span class="text-success"> ({{$thisCategory}})</span> Result(s)</strong>
          @endif
          <div class="row">
            {{-- card template --}}
            @if (count($books) < 1)
              ...
              <div class="col-md-4 col-sm-6">
                <div class="book-shopping-card">
                  ...
                  <div class="card-details">
                    <a href="/store/{{ $book->slug }}" class="t-active"> <h4>{{ $book->title }}</h4> </a>
                    @if ($book->price)
